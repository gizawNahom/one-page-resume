...
export function useSectionHandlerOnIntersection() {
    useEffect(() => {
      ...
      const experienceSection = document.querySelector("section#experience") as Element;
    ...
    function sectionHandler(entries: IntersectionObserverEntry[], observer: IntersectionObserver) {
      ...
      function unobserveSection(observer: IntersectionObserver, section: HTMLElement) {
